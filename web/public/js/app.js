...
Cms.booting(function (Vue, router) {
  router.addRoutes([{
    path: '/admin/foo',
    name: 'foo.bar',
...
__webpack_require__(/*! /app/web/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /app/web/resources/sass/app.scss */"./resources/sass/app.scss");
